import React from "react"; // use state allows us to define values as state, it is a hook from
  ...
  return (
    <li>
      <Card className="expense-item">
        ...
        {/* <button onClick={clickHandler}>Change title</button> */} demo
      </Card>
    </li>
  );
};
...
//Whe we remove the use of useState we call the component presentational or useStateless, because it doesn't have state
//it is just there to show some data
